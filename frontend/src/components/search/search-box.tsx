...
export function SearchBox({ onSearch, isLoading = false }: SearchBoxProps) {
  ...
  const placeholderQuestions = language === 'zh' ? [
    ...
    'When will AI-generated anime lose its hype?',
    'Is it still worth switching careers to design?',
    'Which majors will thrive in the AI era?',
    'Which majors will become obsolete in 5 years?',
    'Will coders be replaced by AI within 10 years?',
    'Will small-city housing prices keep falling?',
    'Can Chinese LLMs catch up to GPT by 2027?',
    'Is applying for civil service still a good bet?',
    'How many years of runway do short-video creators have?',
    'When will humanoid robots enter households?',
    'Which white-collar job will AI replace next?',
